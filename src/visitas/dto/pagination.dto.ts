...
export class VisitaFiltersDto extends PaginationDto {
  ...
  @ApiPropertyOptional({ 
    ...
    description: 'Filtrar por fecha_visita exacto (ISO string)' 
  })
  @IsOptional()
  @IsString()
  fecha_visita?: string;
  ...
  @ApiPropertyOptional({ 
    ...
    description: 'Filtrar por resultado (búsqueda parcial)' 
  })
  @IsOptional()
  @IsString()
  resultado?: string;
